...
export class ColorSelectorButton extends GUIElement {
    ...
    init() {
        const colorSelectorMain = new ColorSelectorMain(this.drawApp, 'ColorSelectorMain');
        ...
        const colorSelectorSec = new ColorSelectorSecondary(this.drawApp, 'ColorSelectorSecondary');
